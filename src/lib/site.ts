import { SITE_NAME, SITE_TAGLINE, SITE_URL_DEFAULT, BASE_PATH, UMBRELLA_NAME, DATA_SOURCES, SOURCE_CITATIONS, DOI, DOI_URL } from "../../brand";
export { SITE_NAME, SITE_TAGLINE, UMBRELLA_NAME, DATA_SOURCES, SOURCE_CITATIONS, BASE_PATH, DOI, DOI_URL };
