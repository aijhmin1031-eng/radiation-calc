...
export const SOURCES: Record<string, Source> = {
  ...
  marssim: {
    key: "marssim",
    label: "MARSSIM",
    cite: "Multi-Agency Radiation Survey and Site Investigation Manual (MARSSIM), NUREG-1575 Revision 1 / EPA 402-R-97-016 Rev. 1 / DOE/EH-0624 Rev. 1, August 2000. Chapter 6, Field Measurement Methods and Instrumentation.",
    url: "https://www.epa.gov/sites/default/files/2017-09/documents/marssim_manual_rev1.pdf",
    access: "Published without charge by the US NRC, EPA and DOE. Revision 1 is the final issue; the Revision 2 draft is marked not for citation and is not used here.",
  },
  currie: {
    key: "currie",
    label: "Currie (1968)",
    cite: "Currie, L. A., Limits for Qualitative Detection and Quantitative Determination: Application to Radiochemistry, Analytical Chemistry 40, 586-593 (1968).",
    url: "https://doi.org/10.1021/ac60259a007",
    access: "Behind a subscription. It is cited here through MARSSIM's restatement of its results, which is quoted verbatim rather than paraphrased.",
  },
  podgorsak: {
    key: "podgorsak",
...
export const STATEMENTS: Statement[] = [
  ...
  { id: "currie-forms", source: "marssim", locator: "page 6-34, equations (6-5) and (6-6)",
    text: "L_C = k√(2B) and L_D = k² + 2k√(2B), where L_C is the critical level in counts, L_D is the detection limit in counts, k is the Poisson probability sum for alpha and beta (assuming alpha and beta are equal), and B is the number of background counts expected to occur while performing an actual measurement. If values of 0.05 for both alpha and beta are selected as acceptable, then k = 1.645 and these can be written as L_C = 2.33√B and L_D = 3 + 4.65√B." },
  { id: "currie-constant", source: "marssim", locator: "page 6-34, note under equation (6-6)",
    text: "Note: In Currie's derivation, the constant factor of 3 in the L_D formula was stated as being 2.71, but since that time it has been shown (Brodsky 1992) and generally accepted that a constant factor of 3 is more appropriate. If the sample count times and background count times are different, a slightly different formulation is used." },
  { id: "paired-blanks", source: "marssim", locator: "page 6-34",
    text: "Currie assumed “paired blanks” when deriving the above stated relationships (Currie 1968), which is interpreted to mean that the sample and background count times are the same." },
  { id: "dprime-table", source: "marssim", locator: "page 6-40, Table 6.5",
    text: "Values of d′ for selected true positive and false positive proportions. At a false positive proportion of 0.60 and a true positive proportion of 0.95, d′ = 1.38. At a false positive proportion of 0.25 and the same true positive proportion, d′ = 2.32." },
  { id: "mdcr", source: "marssim", locator: "pages 6-40 and 6-41, equations (6-8) and (6-9)",
    text: "The minimum detectable number of net source counts in the interval is given by s_i = d′√(b_i), and MDCR = s_i × (60/i), where b_i is the average number of background counts in the observation interval i." },
  { id: "two-stage", source: "marssim", locator: "pages 6-40 to 6-42",
    text: "Scanning is divided into two stages. At the first stage a high rate of correct detections is required (e.g., 95%) and a correspondingly high rate of false positives (e.g., 60%) will be tolerated, giving d′ = 1.38. At the second stage the required rate of true positives remains high (e.g., 95%) but fewer false positives (e.g., 20%) can be tolerated, such that d′ is now 2.48. The greater value of MDCR from each of the scan stages is used." },
  { id: "scan-mdc", source: "marssim", locator: "page 6-43, equation (6-10)",
    text: "Scan MDC = MDCR / (√p · ε_i · ε_s · (probe area / 100 cm²)), where MDCR is the minimum detectable count rate, ε_i is the instrument efficiency, ε_s is the surface efficiency and p is the surveyor efficiency." },
